...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label5->Text = L"Введите матрицу";
			// 
			// label6
			// 
			...
			this->label6->Text = L"Начальный вектор X(1)";
			// 
			// button1
			// 
			...
			this->label7->Text = L"Собственные значения";
			// 
			// label8
			// 
			...
			this->label8->Text = L"Собственные векторы";
			// 
			// listBox1
			// 
			...
			this->radioButton2->Text = L"Из файла";
			...
			this->radioButton1->Text = L"С клавиатуры";
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(3) {
				this->оПрограммеToolStripMenuItem,
					this->помощьToolStripMenuItem, this->выходToolStripMenuItem
			});
			...
			this->label15->Text = L"Погрешность";
			// 
			// label14
			// 
			...
			this->label14->Text = L"Собственные";
			// 
			// label13
			// 
			...
			this->label11->Text = L"Собственные";
			// 
			// label10
			// 
			...
			this->Name = L"MyForm";
			this->Text = L"Собственные значения, собственные вектора";
...
#pragma endregion
		array<array<double>^>^ ReadFromFile(String^ filename, int& n, int& K, int& N, double& e) {
			...
			StreamReader^ objReader = gcnew StreamReader(filename);// ("e:\\test.txt");
			String^ sLine = "";
			array<String^>^ x;
			double a[M * M];
			int j = 0;
		...
		array<array<double>^>^ Matr(int K, int N, double e, double mas[][M], double x[]) {
			...
			for (int b = 1; b <= K; b++) {
				...
				// "Собственное значение L и его вектор Y";
				local[b - 1][0] = l;
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		String^ fs; // строка для вывода в ListBox
		...
		else MessageBox::Show("Введите eps, матрицу и вектор.", "Ошибка в исходных данных");
	}
	private: System::Void textBox1_KeyPress(System::Object^ sender, System::Windows::Forms::KeyPressEventArgs^ e) {
		// разрешаем ввод только десятичных цифр, '-', ',', BackSpace и Delete
	...
	private: System::Void оПрограммеToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		MessageBox::Show("Программа для выполнения курсовой работы по теме:\n"
			"'Разработка программы определения собственных значений симметричной матрицы'\n"
			"Среда программирования - Visual Studio C++ 2019\n"
			"Разработал: Шишкин Данил Сергеевич\n"
			"Cтудент - группы ИНБс-2301\n"
			"Версия " + Application::ProductVersion + "\n"
			"Год: 2020 \n\n"
			"Чтобы выйти из пункта меню 'О программе', нажмите на кнопку 'ОК' или на крестик", "О программе");
	}
	private: System::Void помощьToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e) {
		MessageBox::Show("Здравствуйте!\n"
			"Вы зашли в меню программы 'Помощь'.\n"
			"Здесь будет информация по пользованию программой.\n\n"
			"1) Выбираете как вы будете вводить данные.\n"
			"Есть 2 способа: с клавиатуры или из файла.\n\n"
			"· Если выбрано с клавиатуры, то вы должны задать\n"
			"размерность матриы n, число собственных значений K, векторов N "
			"и погрешность вычислений eps,\n"
			"(при этом должно выполняться 1<=K<=N=n).\n"
			"Дальше вы вводите данные в матрицу и задаете начальный вектор Х(1)\n"
			"Затем нажимаете кнопку 'Вычислить'\n"
			"Результаты собственных значений и собственных векторов появляются на экране.\n\n"
			"· Если вы хотите ввести данные из файла, то выбираете этот пункт в меню 'Исходные данные',\n"
			"выскакивает окно, где выбираете нужный вам файл с исходными данными.\n"
			"После выбора, поля заполняются автоматически.\n"
			"Нажимаете кнопку 'Вычислить' и результаты появляются на экране\n\n"
			"2) При нажатии кнопки меню 'О программе', показывается информация, такая как:\n"
			"тема курсовой работы, среда программирования, разработчик, версия и год.\n\n"
			"3) При нажатии кнопки меню 'Выход', программа будет закрыта.\n\n"
			"Чтобы выйти из пункта меню 'Помощь', нажмите на кнопку 'ОК' или на крестик", "Помощь");
	}
